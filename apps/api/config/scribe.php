...
return [
    ...
    'static' => [
        ...
        'output_path' => storage_path('app/private/scribe'),
    ],
    ...
    'openapi' => [
        ...
        'overrides' => [
            'info.title' => 'Leverly API',
            'info.version' => '0.1.0',
            'info.description' => 'Versioned JSON API for Leverly.',
        ],
