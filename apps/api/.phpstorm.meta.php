    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Laravel\Fortify\Contracts\LoginResponse' => \App\Http\Responses\Auth\LoginResponse::class,
            ...
            'Laravel\Fortify\Contracts\RegisterResponse' => \App\Http\Responses\Auth\RegisterResponse::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/thijs/business/leverly/apps/api/public/storage' => 'string',
            ...
            'fortify.limiters.register' => 'string',
            ...
            'logging.channels.stack.tap' => 'array',
            ...
            'logging.channels.slack.tap' => 'array',
            ...
            'logging.channels.papertrail.tap' => 'array',
            ...
            'logging.channels.stderr.tap' => 'array',
            ...
            'logging.channels.syslog.tap' => 'array',
            ...
            'logging.channels.errorlog.tap' => 'array',
            ...
            'scribe.openapi.overrides.info.title' => 'string',
            'scribe.openapi.overrides.info.version' => 'string',
            'scribe.openapi.overrides.info.description' => 'string',
...
'hashing.argon.verify','hashing.rehash_on_login','app.name','app.env','app.debug',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/thijs/business/leverly/apps/api/public/storage',
...
'fortify.lowercase_usernames','fortify.limiters.login','fortify.limiters.register','fortify.paths.login','fortify.paths.logout',
...
'ide-helper.soft_deletes_force_nullable','ide-helper.post_migrate','logging.default','logging.deprecations.channel','logging.deprecations.trace',
'logging.channels.stack.driver','logging.channels.stack.channels','logging.channels.stack.ignore_exceptions','logging.channels.stack.tap','logging.channels.single.driver',
...
'logging.channels.slack.replace_placeholders','logging.channels.slack.tap','logging.channels.papertrail.driver','logging.channels.papertrail.level','logging.channels.papertrail.handler',
'logging.channels.papertrail.handler_with.host','logging.channels.papertrail.handler_with.port','logging.channels.papertrail.handler_with.connectionString','logging.channels.papertrail.processors','logging.channels.papertrail.tap',
...
'logging.channels.stderr.processors','logging.channels.stderr.tap','logging.channels.syslog.driver','logging.channels.syslog.level','logging.channels.syslog.facility',
'logging.channels.syslog.replace_placeholders','logging.channels.syslog.tap','logging.channels.errorlog.driver','logging.channels.errorlog.level','logging.channels.errorlog.replace_placeholders',
'logging.channels.errorlog.tap','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.sentry.driver',
...
'scribe.title','scribe.description','scribe.intro_text','scribe.base_url','scribe.routes.0.match.prefixes',
...
'scribe.auth.placeholder','scribe.auth.extra_info','scribe.example_languages','scribe.postman.enabled','scribe.postman.overrides',
'scribe.openapi.enabled','scribe.openapi.version','scribe.openapi.overrides.info.title','scribe.openapi.overrides.info.version','scribe.openapi.overrides.info.description',
'scribe.openapi.generators','scribe.groups.default','scribe.groups.order','scribe.logo','scribe.last_updated',
'scribe.examples.faker_seed','scribe.examples.models_source','scribe.strategies.metadata','scribe.strategies.headers','scribe.strategies.headers.2.1.only',
...
'scribe.strategies.bodyParameters','scribe.strategies.responses','scribe.strategies.responseFields','scribe.database_connections_to_transact','scribe.fractal.serializer',
'sentry.dsn','sentry.release','sentry.environment','sentry.org_id','sentry.sample_rate',
'sentry.traces_sample_rate','sentry.profiles_sample_rate','sentry.strict_trace_continuation','sentry.enable_logs','sentry.log_flush_threshold',
...
'sentry.tracing.missing_routes','sentry.tracing.continue_after_response','sentry.tracing.default_integrations','sentry.before_send','sentry.before_send_transaction',
...
'telescope.ignore_paths','telescope.ignore_commands','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.ignore','telescope.watchers.Laravel\\Telescope\\Watchers\\ExceptionWatcher',
'telescope.watchers.Laravel\\Telescope\\Watchers\\JobWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\LogWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\LogWatcher.level','telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.ignore_packages',
'telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.ignore_paths','telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.slow','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.size_limit','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_http_methods',
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.prune.hours','tinker.commands','tinker.alias',
...
'api.v1.health','api.v1.me','api.v1.me.onboarding.show','api.v1.me.onboarding.update','api.v1.me.profile.show',
'api.v1.me.profile.update','login.store','register.store',
...
'TELESCOPE_ENABLED','TELESCOPE_PATH','TELESCOPE_PRUNE_HOURS','SENTRY_LARAVEL_DSN','SENTRY_RELEASE',
'SENTRY_ENVIRONMENT','SENTRY_SAMPLE_RATE','SENTRY_TRACES_SAMPLE_RATE','SENTRY_PROFILES_SAMPLE_RATE','SENTRY_ENABLE_LOGS',
