...
class UpsertAthleteProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'baseline_tests' => ['sometimes', 'array:push_ups,pull_ups,dips,squat,hollow_hold_seconds'],
            ...
            'baseline_tests.pull_ups' => ['sometimes', 'array:max_strict_reps'],
            'baseline_tests.pull_ups.max_strict_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'baseline_tests.dips' => ['sometimes', 'array:max_strict_reps'],
