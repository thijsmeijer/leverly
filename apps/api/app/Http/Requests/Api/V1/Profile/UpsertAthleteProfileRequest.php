...
class UpsertAthleteProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'weight_trend' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::WEIGHT_TRENDS)],
            ...
            'pain_flags' => ['sometimes', 'array:wrist,elbow,shoulder,low_back,knee,ankle'],
            'pain_flags.*' => ['array:severity,status,notes'],
            'pain_flags.*.severity' => ['required', 'string', Rule::in(AthleteProfileOptions::PAIN_SEVERITIES)],
            'pain_flags.*.status' => ['required', 'string', Rule::in(AthleteProfileOptions::PAIN_STATUSES)],
            'pain_flags.*.notes' => ['sometimes', 'nullable', 'string', 'max:300'],
            'baseline_tests' => ['sometimes', 'array:push_ups,pull_ups,dips,squat,rows,lower_body,hollow_hold_seconds,passive_hang_seconds,top_support_hold_seconds'],
            'baseline_tests.push_ups' => ['sometimes', 'array:max_strict_reps'],
            'baseline_tests.push_ups.max_strict_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:200'],
            'baseline_tests.pull_ups' => ['sometimes', 'array:max_strict_reps,fallback_variant,fallback_reps,fallback_seconds'],
            'baseline_tests.pull_ups.max_strict_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'baseline_tests.pull_ups.fallback_variant' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::PULL_UP_FALLBACK_VARIANTS)],
            'baseline_tests.pull_ups.fallback_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'baseline_tests.pull_ups.fallback_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
            'baseline_tests.dips' => ['sometimes', 'array:max_strict_reps,fallback_variant,fallback_reps,fallback_seconds'],
            'baseline_tests.dips.max_strict_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'baseline_tests.dips.fallback_variant' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::DIP_FALLBACK_VARIANTS)],
            'baseline_tests.dips.fallback_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'baseline_tests.dips.fallback_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
            'baseline_tests.squat' => ['sometimes', 'array:barbell_load_value,barbell_reps'],
            'baseline_tests.squat.barbell_load_value' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:1000'],
            'baseline_tests.squat.barbell_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:30'],
            'baseline_tests.rows' => ['sometimes', 'array:variant,max_reps'],
            'baseline_tests.rows.variant' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::ROW_VARIANTS)],
            'baseline_tests.rows.max_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'baseline_tests.lower_body' => ['sometimes', 'array:variant,load_value,load_unit,reps'],
            'baseline_tests.lower_body.variant' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::LOWER_BODY_TEST_VARIANTS)],
            'baseline_tests.lower_body.load_value' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:1000'],
            'baseline_tests.lower_body.load_unit' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::BODYWEIGHT_UNITS)],
            'baseline_tests.lower_body.reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'baseline_tests.hollow_hold_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
            'baseline_tests.passive_hang_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
            'baseline_tests.top_support_hold_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
    ...
    public function bodyParameters(): array
    {
        return [
            ...
            'weight_trend' => ['description' => 'Current bodyweight direction.', 'example' => 'maintaining'],
            ...
            'pain_flags' => [
                'description' => 'Structured regional pain or recent-injury flags.',
                'example' => [
            ...
            'skill_statuses' => [
                ...
                'example' => ['handstand' => ['status' => 'freestanding_kick_up', 'best_hold_seconds' => 20]],
            ],
            'mobility_checks' => [
            ...
            'weekly_session_goal' => ['description' => 'Maximum training sessions per week.', 'example' => 4],
