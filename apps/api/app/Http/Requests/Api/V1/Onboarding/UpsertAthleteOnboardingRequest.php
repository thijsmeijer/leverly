...
class UpsertAthleteOnboardingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'goal_modules.*.metric_type' => ['required', 'string', Rule::in(AthleteOnboardingOptions::GOAL_MODULE_METRIC_TYPES)],
            ...
            'goal_modules.*.quality' => ['sometimes', 'string', Rule::in(AthleteOnboardingOptions::GOAL_MODULE_QUALITY_MARKERS)],
            ...
            'current_level_tests' => ['sometimes', 'array:push_ups,pull_ups,dips,squat,rows,lower_body,hollow_hold_seconds,passive_hang_seconds,top_support_hold_seconds'],
            ...
            'current_level_tests.pull_ups' => ['sometimes', 'array:max_strict_reps,fallback_variant,fallback_reps,fallback_seconds'],
            'current_level_tests.pull_ups.max_strict_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'current_level_tests.pull_ups.fallback_variant' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::PULL_UP_FALLBACK_VARIANTS)],
            'current_level_tests.pull_ups.fallback_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'current_level_tests.pull_ups.fallback_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
            'current_level_tests.dips' => ['sometimes', 'array:max_strict_reps,fallback_variant,fallback_reps,fallback_seconds'],
            'current_level_tests.dips.max_strict_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'current_level_tests.dips.fallback_variant' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::DIP_FALLBACK_VARIANTS)],
            'current_level_tests.dips.fallback_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'current_level_tests.dips.fallback_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
            ...
            'current_level_tests.rows' => ['sometimes', 'array:variant,max_reps'],
            'current_level_tests.rows.variant' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::ROW_VARIANTS)],
            'current_level_tests.rows.max_reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'current_level_tests.lower_body' => ['sometimes', 'array:variant,load_value,load_unit,reps'],
            'current_level_tests.lower_body.variant' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::LOWER_BODY_TEST_VARIANTS)],
            'current_level_tests.lower_body.load_value' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:1000'],
            'current_level_tests.lower_body.load_unit' => ['sometimes', 'string', Rule::in(AthleteProfileOptions::BODYWEIGHT_UNITS)],
            'current_level_tests.lower_body.reps' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:100'],
            'current_level_tests.hollow_hold_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
            'current_level_tests.passive_hang_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
            'current_level_tests.top_support_hold_seconds' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:600'],
    ...
    public function bodyParameters(): array
    {
        return [
            ...
            'pain_flags' => [
                ...
                'example' => [
                    'wrist' => ['severity' => 'mild', 'status' => 'recurring', 'notes' => 'Wrists need longer warm-up.'],
    ...
    private function validateGoalModules(Validator $validator): void
    {
        ...
        $primaryTargetSkill = is_string($candidate['primary_target_skill'] ?? null)
            ? $candidate['primary_target_skill']
            : null;
